...
Visit https://github.com/Pandaura/PTS-Team/wiki/Google-OAuth-Keys in order to generate your Client ID! 
...
Visit https://github.com/Pandaura/PTS-Team/wiki/Google-OAuth-Keys in order to generate your Secret! 
